...
enum Layers { OBSTACLES=0, ACTORS=1, DAMAGE_SOURCES=2, ACTIVATION_TRIGGERS=3, ACTIVATION_SCANNERS=4, PLAYER_STOPPERS=5, DROP_THROUGH=6, PASSABLE_ACTORS=7, ENEMY_STOPPERS=8 }
